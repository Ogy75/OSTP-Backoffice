...
$(document).ready(function () {
    ...
    $('.addLanguage_js').on('click', function () {
        $(this).parents('.modal-body').find('.langTable').append('<div class="border-bottom-dashed lang-item py-3 row"><div class="col-12 col-md-4 mb-md-0 mb-3"><div class=select-dropdown><label>Language</label><button><p>English</p><span class=material-symbols-outlined>expand_more</span></button><ul class=item-list><div class=form-search><input class=form-control placeholder="find item"></div><li value=1 class=active>English<li value=2>item 2<li value=3>item 3<li value=4>item 4<li value=5>item 5<li value=6>item 6</ul></div></div><div class="col-10 col-md-7 mb-0"><div class="input-form"><label>Translation</label> <input class=form-control></div></div><div class="align-items-md-center align-items-start col-1 d-flex justify-content-center"><button class="btn-remove deleteLang_js" type="button"><span class="material-symbols-outlined">close</span></button></div></div>');
